...
import 'package:pool_coordinator/src/plans.dart' show testPlan;


/// Copied from tstokenlib/test/pool_chain_fixture.dart so this package builds
/// the same chain the library's tests do; the library keeps it in its test
/// directory, which a dependent cannot import.
///
